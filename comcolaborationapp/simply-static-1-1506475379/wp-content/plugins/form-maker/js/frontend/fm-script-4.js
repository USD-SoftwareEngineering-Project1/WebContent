    ...
    var required_fields4 = ["6"];
    var labels_and_ids4 = {"2":"type_radio","3":"type_radio","4":"type_own_select","5":"type_radio","6":"type_captcha","7":"type_submit_reset"};
 ...
 function before_reset4()
{
  ...
  jQuery("<input type=\"hidden\" name=\"wdform_5_allow_other4\" value=\"no\" />").appendTo("#form4");
  jQuery("<input type=\"hidden\" name=\"wdform_5_allow_other_num4\" value=\"0\" />").appendTo("#form4");
  var disabled_fields = "";	
