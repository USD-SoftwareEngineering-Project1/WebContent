    ...
    var required_fields6 = ["1","2","3"];
    var labels_and_ids6 = {"1":"type_date_new","2":"type_name","3":"type_submitter_mail","4":"type_checkbox","5":"type_own_select","6":"type_textarea","7":"type_submit_reset"};
 ...
 function before_reset6()
{
    ...
    function onload_js6() {
  jQuery("#button_calendar_1").click(function() {
    jQuery("#wdform_1_element6").datepicker("show");
  });
  jQuery("#wdform_1_element6").datepicker({
  ...
  var default_date;  
  var date_value = jQuery("#wdform_1_element6").val();  
  (date_value != "") ? default_date = date_value : default_date = "";
  var format_date = "mm/dd/yy";
  jQuery("#wdform_1_element6").datepicker("option", "dateFormat", format_date);
  if(default_date == "today") {
    jQuery("#wdform_1_element6").datepicker("setDate", new Date());
  }
  else if (default_date.indexOf("d") == -1 && default_date.indexOf("m") == -1 && default_date.indexOf("y") == -1 && default_date.indexOf("w") == -1) {
    jQuery("#wdform_1_element6").datepicker("setDate", default_date);
  }
  else {
    jQuery("#wdform_1_element6").datepicker("setDate", default_date);
  }
